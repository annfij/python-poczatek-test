...
# Użyj dict comprehensions, aby zamienić listę pozycji zamówienia w słownik, gdzie kluczem będzie identyfikator
# produktu z danej pozycji, a wartością będzie dany obiekt klasy Product.
