...
#
# Klasa ta będzie reprezentować zamówienie z ekspresowym terminem dostawy. Względem klasy Order powinna dodatkowo
# przyjmować informacje o terminie dostawy (jako data w postaci napisu) oraz naliczać dodatkową opłatę za
# ekspresową dostawę w ramach obliczania łącznego kosztu zamówienia.
