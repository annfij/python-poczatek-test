...
# Skorzystaj z dict comprehensions, aby na podstawie słownika z produktami stworzyć nowy, w którym każdy produkt
# będzie pod kluczem o 1 większym.
...
def run_homework():
    ...
    identifier_to_product.update(changed_ids)
    print(identifier_to_product)
