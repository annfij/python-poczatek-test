...
#
# W klasie Order zastąp listę produktów listą pozycji w zamówieniu (zmodyfikuj niezbędne funkcje,
# np. generowanie zamówienia). Napisz metodę obliczającą łączną wartość zamówienia jako sumę wartości
# wszystkich pozycji (wykorzystując wcześniej napisaną metodę z klasy OrderElement)
